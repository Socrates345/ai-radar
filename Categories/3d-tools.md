...
### [Meta ShapeR](https://facebookresearch.github.io/ShapeR/) — `03.2026`

Meta's metric 3D shape reconstruction from casual multi-view image sequences and sparse SLAM points.
`open-source` `research`

### [UniMesh](https://aigeeksgroup.github.io/UniMesh/) — `04.2026`

Edit 3D models using text prompts.
`open-source` `research`

### [Vista4D](https://eyeline-labs.github.io/Vista4D/) — `04.2026`

Reconstruct a 4D scene (3D + time) from a video.
`open-source` `research`

### [Video to World](https://lukashoel.github.io/video_to_world/) — `03.2026`

Generate a navigable 3D world from a video.
`open-source` `research`

### [Lyra 2](https://research.nvidia.com/labs/sil/projects/lyra2/) — `11.2024`

NVIDIA's explorable generative 3D worlds.
`open-source` `research`

### [Hunyuan World](https://3d-models.hunyuan.tencent.com/world/) — `05.2025`

Tencent's world creator — generates full navigable maps and environments.
`open-source` `research`

### [WorldLabs](https://www.worldlabs.ai/blog/marble-world-model) — `10.2024`

Image-to-interactive-3D world generation.
`online` `<!-- TODO: verify cost -->`

### [Genie 2](https://deepmind.google/discover/blog/genie-2-a-large-scale-foundation-world-model/) — `12.2024`

Google DeepMind's large-scale foundation world model.
`research`

### [Pixie 3D](https://pixie-3d.github.io/) — `08.2025`

Generate 3D scenes with correct physics simulation.
`open-source` `research`

### [IGGT](https://lifuguan.github.io/IGGT_official/) — `02.2025`

Reconstruct a room in 3D from photos, with object identification.
`open-source` `research`

### [3DRegen](https://3dregen.jdihlmann.com/) — `03.2025`

Image-to-3D scene reconstruction with multi-layer depth for interior spaces.
`open-source` `research`

### [MV-Inverse](https://maddog241.github.io/mvinverse-page/) — `12.2025`

Image-to-3D scene with multi-layer decomposition; runs locally.
`open-source` `local` `research`
...
### [Depth Anything 3](https://depth-anything-3.github.io/) — `11.2025`

Image and video to 3D scene reconstruction via monocular depth estimation.
`open-source` `research`

### [WildDet3D](https://allenai.github.io/WildDet3D/) — `04.2025`

3D person and object detection from in-the-wild images and video.
`open-source` `research`

### [Utonia](https://pointcept.github.io/Utonia/) — `05.2025`

3D model that understands and processes point cloud data.
`open-source` `research`

### [ArtiFixer](https://research.nvidia.com/labs/sil/projects/artifixer/) — `06.2025`

Enhanced 3D reconstruction using auto-regressive diffusion models (NVIDIA).
`open-source` `research`

### [4K Gaussian Splatting](https://yxlao.github.io/lgtm/) — `04.2025`
...
### [MoCapAnything V2](https://animotionlab.github.io/MoCapAnythingV2/) — `05.2025`

Accurate skeleton mesh and motion capture from any input.
`open-source` `research`

### [SkinTokens](https://arxiv.org/html/2602.04805v1) — `02.2026`

Autoregressive rigging of 3D characters.
`open-source` `research`

### [GeoSAM2](https://detailgen3d.github.io/GeoSAM2/) — `08.2025`

Segment 3D objects and meshes with SAM2-like precision.
`open-source` `research`

### [Hunyuan3D Part](https://github.com/Tencent-Hunyuan/Hunyuan3D-Part) — `05.2025`

Segment and decompose 3D objects into individual parts.
`open-source` `research`

### [SegviGen](https://fenghora.github.io/SegviGen-Page/) — `03.2026`

Auto-colored 3D models ready for easy segmentation.
`open-source` `research`

### [Skeleton-Conditioned Generation](https://sk-adapter.github.io/) — `06.2025`

Generate 3D content conditioned on skeleton input.
`open-source` `research`

### [AniGen](https://github.com/VAST-AI-Research/AniGen) — `04.2025`
...
### [One-to-All Animation](https://github.com/ssj9596/One-to-All-Animation) — `05.2025`

Animate a character image across multiple motion styles.
`open-source` `research`

### [PhysX-Anything](https://physx-anything.github.io/) — `11.2025`

Predict 3D object kinematics and physics from an image.
`open-source` `research`

### [MorphAny3D](https://xiaokunsun.github.io/MorphAny3D.github.io/) — `01.2026`
...
### [VoxHammer](https://huanngzh.github.io/VoxHammer-Page/) — `08.2025`

Voxel-based 3D editing tool.
`open-source` `research`

### [Tinker](https://aim-uofa.github.io/Tinker/) — `08.2025`

3D video editor for scene and object manipulation.
`open-source` `research`

### [OccluGaussian](https://occlugaussian.github.io) — `04.2025`
...
### [MoCA](https://lizhiqi49.github.io/MoCA) — `12.2025`

Image-to-3D model with split, individually movable parts.
`open-source` `research`

### [3D Agent](https://moonlakeai.com/blog/3d-agent) — `05.2025`

Agentic 3D world building that works directly with tools like Blender.
`online` `<!-- TODO: verify cost -->`

### [SARAH](https://evonneng.github.io/sarah/) — `06.2025`
