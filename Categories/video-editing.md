...
#### [Edit-Yourself](https://edit-yourself.github.io/) — `02.2026` — `open-source` `research`
Live video editing that adjusts lip sync in real time to match custom lyrics or audio.
#### [MoCha](https://orange-3dv-team.github.io/MoCha/) — `01.2026` — `open-source` `research`
Swap characters between videos while preserving motion and scene context.
#### [DreamID-V](https://guoxu1233.github.io/DreamID-V/) — `01.2026` — `open-source` `research`
Very accurate face swap from a single reference photo.
#### [Luma Ray](https://lumalabs.ai/ray) — `12.2025` — `online` `freemium`
Luma AI's live video editor; best-in-class for video modification workflows at release.
#### [ProEdit](https://isee-laboratory.github.io/ProEdit/) — `12.2025` — `open-source` `research`
Versatile AI model for both image and video editing.
#### [MatAnyone 2](https://pq-yang.github.io/projects/MatAnyone2/) — `12.2025` — `open-source` `research`
...
#### [SeC](https://rookiexiong7.github.io/projects/SeC/) — `07.2025` — `open-source` `research`
Track and precisely select objects across video frames.
#### [Lucy Edit](https://github.com/DecartAI/Lucy-Edit-ComfyUI/) — `06.2025` — `open-source` `local` `free`
Decart AI's video editing model, available as a ComfyUI integration.
#### [Luma Modify](https://lumalabs.ai/news/introducing-modify-video) — `06.2025` — `online` `freemium`
Luma AI's video modification tool — impressively capable real-time video transformation.
#### [LayerFlow](https://sihuiji.github.io/LayerFlow-Page/) — `06.2025` — `open-source` `research`
Layer-based video editing: decompose and edit video as independent compositable layers.
#### [ObjectClear](https://github.com/zjx0101/ObjectClear) — `05.2025` — `open-source` `research`
Remove objects from video with clean background reconstruction.
#### [OmniSync](https://ziqiaopeng.github.io/OmniSync/) — `05.2025` — `open-source` `research`
Synchronize lip movements to any audio track in a video.
#### [Any2Bokeh](https://vivocameraresearch.github.io/any2bokeh/) — `05.2025` — `open-source` `research`
Apply professional background blur (bokeh) to any video (Vivo Research).
#### [VideoAnyDoor](https://videoanydoor.github.io/) — `05.2025` — `open-source` `research`
Insert objects from a reference image into an existing video with realistic motion.
#### [FlexiAct](https://shiyi-zh0408.github.io/projectpages/FlexiAct/) — `05.2025` — `open-source` `research`
...
#### [KREA AI](https://www.krea.ai/) — `online` `freemium`
...
#### [STAR](https://nju-pcalab.github.io/projects/STAR/) — `01.2025` — `open-source` `research`
Upscale video quality with structure-aware temporal super-resolution.
#### [SVFR](https://wangzhiyaoo.github.io/SVFR/) — `01.2025` — `open-source` `research`
