...
6. Do not add a tool that is superseded by a newer version already in the list
...
- Tools without a public link
- Tools that are clearly inferior to an existing entry in the same category
- Personal projects or tools you are affiliated with without disclosure
